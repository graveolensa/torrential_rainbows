...
__device__  cuComplex intega(int a)
{
return cuComplex(a,0.0);
}
...
void distanceKernel(uchar4 *d_out, int w, int h, int2 pos) {
  ...
  cuComplex bi(3.14159265484898,0.0);
...
/*    cuComplex uon(cosf(-2*pi*ticks/16384.0),sinf(-2*pi*ticks/16384.0));
   ...
   cuComplex nom = expc(tir*bi*ai*q);
...
for(v=0;v<30;v++)
{
    cue = cue - (cue*(intega(3) + intega(2) *cue- aon*intega(12)* cue*cue - intega(13)* cue*uon*cue + intega(21) *cue*cue*cue*cue +  intega(6) *cue*cue*cue*cue*cue - intega(12) *cue*cue*cue*cue*cue*cue + intega(3)*cue*cue*cue*cue*cue*cue*cue))/((intega(-1) + cue) *(intega(-3) - intega(7)* cue+  intega(29)*cue*cue + intega(81)* cue*cue*cue - intega(24)* cue*cue*cue*cue - intega(60)* cue*cue*cue*cue*cue + intega(24)* cue*cue*cue*cue*cue*cue));
}
