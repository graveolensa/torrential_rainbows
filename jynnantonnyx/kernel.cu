...
cue =(cue - uon/(cue-conj(aon/conj(cue - uon/conj(cue)))))/(cue + aon/(cue+conj(uon/conj(cue + aon/conj(cue)))));
cue =(cue - ai*uon/(cue-ai*conj(aon/conj(cue - uon/conj(cue)))))/(cue + ai* aon/(cue+ai*conj(uon/conj(cue + aon/conj(cue)))));
accume = accume * (unity-aon*sins(cue));
}

cue = the3(cue,flat(accume)*fixon*aon);
