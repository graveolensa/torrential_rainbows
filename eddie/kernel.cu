...
cue =(cue - uon/(cue-conj(hilva(aon/conj(cue - uon/conj(cue))))))/(cue + aon/(cue+conj(uon/conj(halvi(cue + aon/conj(cue))))));
cue =(cue - ai*uon/(cue-ai*conj(halvi(aon/conj(cue - uon/conj(cue))))))/(cue + ai* aon/(cue+ai*conj(uon/conj(hilva(cue + aon/conj(cue))))));
accume = accume * (unity-aon*hilva(cue))/(unity-uon*halvi(cue));
}
