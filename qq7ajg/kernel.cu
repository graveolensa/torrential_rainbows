...
for(v=0;v<20;v++)
{
    cue = cue - (conj(powc(aon,cue))-powc(aon,conj(cue)))/(conj(powc(uon,cue))-powc(uon,conj(cue)));
  cue = cue - (hilva(powc(aon,cue))-powc(aon,hilva(cue)))/(hilva(powc(uon,cue))-powc(uon,hilva(cue)));
