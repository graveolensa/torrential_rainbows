...
cue = (powc(powc(arago(flurn,q*aon),rarva*uon)+ powc(the2(flurn,q),rarva) + powc(the4(flurn,q),rarva),rhuva))/powc(the4(flurn,q)*arago(flurn,q*uon)*the2(flurn,q),rarva);
