...
for(v=0;v<3;v++)
{
cue =cue- powc(uon,hilva(cue))-powc(hilva(cue),aon);
accume = accume + powc(uon,hilva(cue));
}


cue = the3(accume,flat(moeb(uon,faxon,cue)));
for(v=0;v<3;v++)
{
cue =cue- powc(uon,hilva(cue))-powc(hilva(cue),aon);
accume = accume + powc(uon,hilva(cue));
}
cue = the3(accume,flat(moeb(aon,fixon,cue)));
